...
#region  Administradores
        ...
        endpoint.MapPost("/Adminstradores/login",
    async Task<IResult> (
    ...
    ) =>
{
    ...
    return Results.Json(new AdministradorLogado
    {
        Email = adm.Email,
        Perfil = adm.Perfil,
        Token = token
...
.WithTags("Administradores");
                ...
                endpoint.MapGet("/Administradores/Mostrar Todos Cadastros", ([FromQuery] int? pagina, IAdministradorServico administradorServico) =>
                {
            ...
            endpoint.MapGet("/Administrador/{id}", ([FromRoute] int id, IAdministradorServico administradorServico) =>
            {
                ...
                if (administrador == null) return Results.NotFound("!!! Adminstrador não cadastrado !!!");
            ...
            endpoint.MapPost("/Adminstradores", ([FromBody] AdministradorDTO administradorDTO, IAdministradorServico administradorServico) =>
            {
...
#region Veiculos
            ...
            ErrosDeValidacao validaDTO(VeiculoDTO veiculoDTO)
            {
                ...
                if (veiculoDTO.Ano <= 1950)
                    validacao.Mensagens.Add("!!!!!!!! Veiculo muito antigo, aceitamos apenas anos superiores 1950 !!!!!!!!!");
